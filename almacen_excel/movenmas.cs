...
namespace almacen_excel
{
    public partial class movenmas : Form
    {
            ...
            try
            {
                if (rb_mov.Checked == true || rb_ajuste.Checked == true)
                {
                    ...
                    {   // ingresa por defecto al almacen del usuario, osea argentina
                        ...
                        micon.Parameters.AddWithValue("@coda", almacen_excel.Program.almuser);
                    ...
                    micin.Parameters.AddWithValue("@asd", almacen_excel.Program.vg_user);
                    micin.Parameters.AddWithValue("@coda", almacen_excel.Program.almuser);
        ...
        private void cmb_cap_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                //string consulta = "select idcodice from desc_gru where descrizionerid=@des and numero=1";
                string consulta = "select idcodice from desc_gru where cnt=@des";
                MySqlCommand micon = new MySqlCommand(consulta, cn);
                //micon.Parameters.AddWithValue("@des", cmb_cap.Text.ToString());
                micon.Parameters.AddWithValue("@des", cmb_cap.SelectedIndex);
                MySqlDataReader midr = micon.ExecuteReader();
                if (midr.Read())
                {
                    this.tx_dat_cap.Text = midr["idcodice"].ToString();
                    //nombre_mueble();
                }
                midr.Close();
                cn.Close();
        ...
        private void cmb_mod_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                //string consulta = "select idcodice from desc_mod where descrizionerid=@des and numero=1";
                //string consulta = "select idcodice from desc_mod where cnt=@des";
                string consulta = "select model as idcodice from items where model=@des group by model";
                MySqlCommand micon = new MySqlCommand(consulta, cn);
                micon.Parameters.AddWithValue("@des", cmb_mod.Text.ToString());
                //micon.Parameters.AddWithValue("@des", cmb_mod.SelectedIndex);
                //micon.Parameters.AddWithValue("@des", tx_dat_cap.Text.Trim());
                MySqlDataReader midr = micon.ExecuteReader();
                if (midr.Read())
                {
                    this.tx_dat_mod.Text = midr["idcodice"].ToString();
                    //nombre_mueble();
                }
                midr.Close();
                cn.Close();
        ...
        private void cmb_mad_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                //string consulta = "select idcodice from desc_mad where descrizionerid=@des and numero=1";
                string consulta = "select idcodice from desc_mad where cnt=@des";
                MySqlCommand micon = new MySqlCommand(consulta, cn);
                //micon.Parameters.AddWithValue("@des", cmb_mad.Text.ToString());
                micon.Parameters.AddWithValue("@des", cmb_mad.SelectedIndex);
                MySqlDataReader midr = micon.ExecuteReader();
                if (midr.Read())
                {
                    this.tx_dat_mad.Text = midr["idcodice"].ToString();
                    //nombre_mueble();
                }
                midr.Close();
                cn.Close();
        ...
        private void cmb_tip_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                string consulta = "select idcodice from desc_tip where cnt=@des and descrizionerid=@cap";
                MySqlCommand micon = new MySqlCommand(consulta, cn);
                micon.Parameters.AddWithValue("@des", cmb_tip.SelectedIndex);
                micon.Parameters.AddWithValue("@cap", tx_dat_cap.Text.Trim());
                MySqlDataReader midr = micon.ExecuteReader();
                if (midr.Read())
                {
                    this.tx_dat_tip.Text = midr["idcodice"].ToString();
                }
                midr.Close();
                cn.Close();
            }
        ...
        private void cmb_det1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                //string consulta = "select idcodice from desc_dt1 where descrizione=@des and numero=1";
                string consulta = "select idcodice from desc_dt1 where cnt=@des";
                //string consulta = "select deta1 as idcodice from items where capit=@des group by deta1";
                MySqlCommand micon = new MySqlCommand(consulta, cn);
                //micon.Parameters.AddWithValue("@des", cmb_det1.Text.ToString());
                micon.Parameters.AddWithValue("@des", cmb_det1.SelectedIndex);
                //micon.Parameters.AddWithValue("@des", tx_dat_cap.Text.Trim());
                MySqlDataReader midr = micon.ExecuteReader();
                if (midr.Read())
                {
                    this.tx_dat_det1.Text = midr["idcodice"].ToString();
                    //nombre_mueble();
                }
                midr.Close();
                cn.Close();
        ...
        private void cmb_aca_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                //string consulta = "select idcodice from desc_est where descrizione=@des and numero=1";
                string consulta = "select idcodice from desc_est where cnt=@des";
                MySqlCommand micon = new MySqlCommand(consulta, cn);
                //micon.Parameters.AddWithValue("@des", cmb_aca.Text.ToString());
                micon.Parameters.AddWithValue("@des", cmb_aca.SelectedIndex);
                MySqlDataReader midr = micon.ExecuteReader();
                if (midr.Read())
                {
                    this.tx_dat_aca.Text = midr["idcodice"].ToString();
                    //nombre_mueble();
                }
                midr.Close();
                cn.Close();
        ...
        private void cmb_tal_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                string consulta = "select codigo from desc_loc where cnt=@des";
                MySqlCommand micon = new MySqlCommand(consulta, cn);
                micon.Parameters.AddWithValue("@des", cmb_tal.SelectedIndex);
                MySqlDataReader midr = micon.ExecuteReader();
                if (midr.Read())
                {
                    this.tx_dat_tal.Text = midr["codigo"].ToString();
                }
                midr.Close();
                cn.Close();
            }
        ...
        private void cmb_det2_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                string consulta = "select idcodice from desc_dt2 where cnt=@des";
                MySqlCommand micon = new MySqlCommand(consulta, cn);
                micon.Parameters.AddWithValue("@des", cmb_det2.SelectedIndex);
                MySqlDataReader midr = micon.ExecuteReader();
                if (midr.Read())
                {
                    this.tx_dat_det2.Text = midr["idcodice"].ToString();
                }
                midr.Close();
                cn.Close();
            }
        ...
        private void cmb_det3_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                string consulta = "select idcodice from desc_dt3 where cnt=@des";
                MySqlCommand micon = new MySqlCommand(consulta, cn);
                micon.Parameters.AddWithValue("@des", cmb_det3.SelectedIndex);
                MySqlDataReader midr = micon.ExecuteReader();
                if (midr.Read())
                {
                    this.tx_dat_det3.Text = midr["idcodice"].ToString();
                }
                midr.Close();
                cn.Close();
            }
